...
export default function SuccessSendMailDialog({ open, handleClose }: { open: boolean; handleClose: Function }) {
  ...
  return (
    <div>
      <Dialog onClose={onHandleClose} aria-labelledby="customized-dialog-title" open={open} maxWidth="xl">
        ...
        <SCDialogContent>
          <SCHeadWrapper>
            <SCHeadContact>Request tick success</SCHeadContact>
          </SCHeadWrapper>
          <SCConfirmMessageWrapper>
            <SCConfirmMessageLabel>We are processing your request please wait for email response</SCConfirmMessageLabel>
            <SCConfirmMessageText>
              Please check email address: <Link href={`mailto: ${profile?.email}`}>{profile?.email}</Link>
            </SCConfirmMessageText>
          </SCConfirmMessageWrapper>
          ...
          <SCButtonWrapper>
            ...
            <SCSentButton onClick={onHandleClose} variant="contained">
              Ok
            </SCSentButton>
          </SCButtonWrapper>
        </SCDialogContent>
